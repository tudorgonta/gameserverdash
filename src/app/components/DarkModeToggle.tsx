  ...
  return (
    <div className="flex justify-end p-4">
      <label className="themeSwitcherThree relative inline-flex cursor-pointer select-none items-center">
        ...
        />
        <div className="z-[100] shadow-card flex h-[46px] w-[82px] items-center justify-center rounded-md">
          {isDarkMode ? (
            <>
                <span
                    className={`flex h-9 w-9 items-center justify-center rounded ${
                        !isDarkMode ? 'bg-primary text-black' : 'text-white'
                    }`}
                    data-tooltip-id={`tooltip-light`}
                ...
                <Tooltip id={`tooltip-light`} place="top" />
            </>
          ) : (
            <>
                <span
                ...
                <Tooltip id={`tooltip-dark`} place="top" />
            </>
          )}
        </div>
      </label>
